...
const { location:{city, state}, name:{fName, lName}, orgs:{first, second}, edu:{high, uni, concen }, community:{heroes, camp, cares}} = person;
...
console.log(`---------`)
console.log(`I have community service experience with ${heroes} from 2005-2007, ${camp}, from 2007-2012, and ${cares} from 2010-2012.`)s